world-clear-primo-rh = \relative c''' {
  ...
  a8.\( bes16 c8-. f->~ f2\)
  a,8.\( bes16 c8-. f->~ f4 g\)
  r8 r16 \ottava #1 bes~\( bes4 a8. f16 g8. f16~--
...
world-clear-secondo-rh = \relative c''' {
  \key f \major
  << {
    s2 r8 r16 \ottava #1 f( <a f'>8)-. \ottava #0 r
    s2 r8 r16 \ottava #1 f( <bes g'>8)-. \ottava #0 r
  } \\ {
  ...
  r8 r16 <d f bes d>~-> q4 <f a c>8. c16 <g' bes>8. <c, f a>16~-- q2 r2
}
